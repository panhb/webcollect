...
import com.hh.webcollect.common.enums.error.system.LoginErrorCode;
...
public class LoginServiceImpl implements LoginService {
    ...
    public UserBO login(LoginVO loginVO) {
        ...
        if (userBO == null) {
            throw new WcException(LoginErrorCode.USER_IS_NOT_EXIST);
        }
        ...
        if (!userBO.getPassword().equals(password)) {
            throw new WcException(LoginErrorCode.PASSWORD_ERROR);
        }
        return userBO;
    }
}
